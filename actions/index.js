const MOVIE_DATA = [
    {
        ...
        cover: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1340&q=80'
    },
    {
        id: '2',
    ...
    },
    {
        ...
        cover: 'https://images.unsplash.com/photo-1506466010722-395aa2bef877?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1488&q=80'
    }
]
...
export const getMovieById = (id) => {
    return new Promise((resolve, reject) => {
        const movieId = MOVIE_DATA.findIndex(m => m.id === id)
